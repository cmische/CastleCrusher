...
bool Controls::init()
{
	...
	//new image
	auto backgroundSprite = Sprite::create("Controls.png");
	...
	auto newGameItem = MenuItemImage::create("newGame.png","newGameSelected.png", CC_CALLBACK_1(Controls::onNewGame, this));
	auto optionsItem = MenuItemImage::create("options.png","optionsSelected.png", CC_CALLBACK_1(Controls::onOptions, this));
	auto exitItem = MenuItemImage::create("exit.png","exitSelected.png", CC_CALLBACK_1(Controls::onExit, this));
...
void Controls::onNewGame(cocos2d::Ref *sender)
{
...
void Controls::onOptions(cocos2d::Ref *sender)
{
...
void Controls::onExit(cocos2d::Ref *sender)
{
